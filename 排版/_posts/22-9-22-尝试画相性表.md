...
<div id="zodiac2">123</div>

### zodiac

<script>
document.getElementById("zodiac").innerHTML="<h3>This is the text which has been inserted by JS</h3>";
  
document.getElementById("用JAVASCRIPT".toLowerCase()).insertAdjacentHTML('afterend', 'additional HTML code1');
</script>
