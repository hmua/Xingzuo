...
{%-assign b="干湿"|split:""%}
{%for i in(0..11)%}{%assign a=i|devide_by:2|modulo:2%}{{a}}|{%endfor%}
{%for i in(0..11)%}{%assign a=i|devide_by:2%}{{a}}|{%endfor%}
{%for i in(0..11)%}{%assign a=i|devide_by:2|modulo:2%}{{b[a]}}|{%endfor%}
0
