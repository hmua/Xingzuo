...
s='style=\'width:100%\''
textarea=(a)=>`<textarea ${s} name="text" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'>${a}</textarea>`
input=(a)=>`<input value=\'${a}\'></input>`
tag=(name,a)=>`<${name}>${a}</${name}>`
division=(a)=>tag('div',a)
pre=(a)=>tag('pre',a)
template=([file,content])=>division(file)+pre(content)
