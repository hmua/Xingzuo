...
#### 以及
1. 所幸是，Actions的启用关闭，在尝试过程中反复多次操作，看来完全没问题，
启用、关闭都很顺畅，用了4，再回到3.9，至少设置上不麻烦。
2. Jekyll4已经很多年了，gh-pages新的Actions支持4，而原classica限定在3.9，
可能出于对现有大量站点的兼容性考虑，
也可能是需要低调，不想破坏商业市场，将gh-pages限定在自己动手意愿强的用户。
3. 不马上升级，应该马上要加入分类方面的功能，到时看情况。
一是文章要分星座和建站、生活板块，二是文学类、应用类文章在排版上要分开。
